...
LibPlayerData.casts = LibPlayerData.casts or {}
LibPlayerData.castTimeDecrease = LibPlayerData.castTimeDecrease or {}
LibPlayerData.castTimeIncrease = LibPlayerData.castTimeIncrease or {}
LibPlayerData.channeled = LibPlayerData.channeled or {}
LibPlayerData.crowdControl = LibPlayerData.crowdControl or {}
LibPlayerData.unitCache = LibPlayerData.unitCache or {}
LibPlayerData.unitCacheBlacklist = LibPlayerData.unitCacheBlacklist or {}

-- Quality of Life
---------------------------------------------------------------------	
local Casts = LibPlayerData.casts
local CastDecrease = LibPlayerData.castTimeDecrease
local CastIncrease = LibPlayerData.castTimeIncrease
local Channeled = LibPlayerData.channeled
local CrowdControl = LibPlayerData.crowdControl
...
---------------------------------------------------------------------	
local rankTranslation, spellRanks
do
...
LibPlayerData.GetSpellRank = function(self, spellID)
...
LibPlayerData.GetSpellInfo = function(self, spellID)
...
LibPlayerData.GetSpellID = function(self, spellName)
	return Casts[spellName]
end

LibPlayerData.GetSpellChannelInfo = function(self, spellName)
...
LibPlayerData.GetSpellCastTimeDecrease = function(self, spellName)
	return CastDecrease[spellName]
end

LibPlayerData.GetSpellCastTimeIncrease = function(self, spellName)
	return CastIncrease[spellName]
end

LibPlayerData.CanAuraInterruptSpellCast = function(self, spellName)
